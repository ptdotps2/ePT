...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1b06; // addresses start with "PT"
...
const int      RPC_DEFAULT_PORT                              =  6771;
const int      RPC_DEFAULT_SSL_PORT                          =  6772;
const int      WALLET_RPC_DEFAULT_PORT                       =  77500;
const int      WALLET_RPC_DEFAULT_SSL_PORT                   =  77100;
const int      GATE_RPC_DEFAULT_PORT                         =  77000;
const int      GATE_RPC_DEFAULT_SSL_PORT                     =  77100;
